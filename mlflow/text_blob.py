...
class TextB(mlflow.pyfunc.PythonModel):
    def __init__(self):
        pass
    ...
    def predict(self, model_input, params=None):
        ...
        for each in model_input:
            res.append(TextBlob(each).sentiment.polarity)
        return res

model_path = "text_blob"
model = TextB()
...
mlflow.set_experiment("MLFlow for Project - TextBlob")

with mlflow.start_run():
    mlflow.set_tag("Model", "Text Blob")
